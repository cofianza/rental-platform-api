-- ============================================================
-- "Requieren mi acción" en el listado de estudios
-- ------------------------------------------------------------
-- Las cuatro acciones que dependen del gestor (habilitar la evaluación,
-- definir el pago, decidir un condicionado y generar el contrato) solo se veían
-- en el widget del dashboard, capado a 5 por categoría y calculado en el
-- cliente. Con 40 estudios activos había que abrir uno por uno para saber cuál
-- espera algo de uno.
--
-- Esta migración reemplaza list_expedientes_with_relations (misma firma) para:
--   * emitir `requiere_accion` (booleano) y `depende_de` ('gestor' | 'prospecto'
--     | 'cofianza' | NULL) en cada fila, y
--   * aceptar p_estudio_filtro = 'requiere_accion'.
--
-- Base: 20260706000004 (cita_omitida). Sin cambios de firma ni de columnas.
-- ROLLBACK: volver a aplicar 20260706000004.
-- ============================================================
