-- ============================================================
-- Incluir las columnas de cancelacion en el RPC del listado.
--
-- Sin esto, el listado de expedientes (dashboards, kanban, sidebar lists,
-- widgets) no recibe `cancelado_at` y la UI no puede distinguir un
-- expediente cancelado de uno cerrado naturalmente — el badge sigue
-- diciendo "Cerrado" gris en lugar de "Cancelado" rojo.
--
-- CREATE OR REPLACE preserva firma, permisos y RLS. Solo cambia los
-- campos del json_build_object para incluir las 3 columnas nuevas.
-- ============================================================
