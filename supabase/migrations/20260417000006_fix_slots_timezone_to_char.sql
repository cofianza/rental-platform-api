-- ============================================================
-- Migración: Fix timezone offset via to_char (Plan B)
-- Fecha: 2026-04-20
-- Descripción:
--   La migración 20260417000005 usó SET LOCAL TIMEZONE pero falló porque
--   Postgres no permite SET en funciones STABLE. Este fix usa to_char con
--   offset literal '-05:00' en el output del JSON. El hardcoding del offset
--   es aceptable porque Colombia no tiene DST.
-- ============================================================
