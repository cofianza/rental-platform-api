...
export const volumenQuerySchema = z.object({
  dateFrom: z.string().regex(isoDateRegex, 'Formato fecha inválido (ISO 8601)').optional(),
  dateTo: z.string().regex(isoDateRegex, 'Formato fecha inválido (ISO 8601)').optional(),
