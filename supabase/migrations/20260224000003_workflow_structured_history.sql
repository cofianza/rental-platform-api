-- ============================================================
-- Workflow: columnas estructuradas en eventos_timeline + RPC actualizado
-- ============================================================

-- 1. Agregar columnas estructuradas a eventos_timeline
--    Solo se llenan para tipo='estado', nullable para otros tipos
ALTER TABLE eventos_timeline
  ADD COLUMN IF NOT EXISTS estado_anterior estado_expediente,
  ADD COLUMN IF NOT EXISTS estado_nuevo estado_expediente,
  ADD COLUMN IF NOT EXISTS comentario TEXT;

-- 2. Actualizar RPC transicionar_expediente con parametro comentario
...
BEGIN
  ...
  -- Insertar evento de timeline con campos estructurados
