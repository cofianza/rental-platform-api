...
export const createInmuebleSchema = z.object({
  ...
  area_m2: z.coerce.number().positive('Area debe ser mayor a 0').max(99999, 'Area no puede superar 99.999 m²').optional(),
  habitaciones: z.coerce.number().int().min(0, 'Habitaciones no puede ser negativo').max(99, 'Maximo 99 habitaciones').default(0),
  banos: z.coerce.number().int().min(0, 'Banos no puede ser negativo').max(99, 'Maximo 99 baños').default(0),
  parqueadero: z.boolean().default(false),
  parqueaderos: z.coerce.number().int().min(0, 'Parqueaderos no puede ser negativo').max(99, 'Maximo 99 parqueaderos').default(0),
...
export const updateInmuebleSchema = z.object({
  ...
  area_m2: z.coerce.number().positive('Area debe ser mayor a 0').max(99999, 'Area no puede superar 99.999 m²').nullable().optional(),
  habitaciones: z.coerce.number().int().min(0, 'Habitaciones no puede ser negativo').max(99, 'Maximo 99 habitaciones').optional(),
  banos: z.coerce.number().int().min(0, 'Banos no puede ser negativo').max(99, 'Maximo 99 baños').optional(),
  parqueadero: z.boolean().optional(),
  parqueaderos: z.coerce.number().int().min(0, 'Parqueaderos no puede ser negativo').max(99, 'Maximo 99 parqueaderos').nullable().optional(),
