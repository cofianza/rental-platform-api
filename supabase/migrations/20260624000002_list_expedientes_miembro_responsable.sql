-- ============================================================
-- list_expedientes_with_relations: incluir miembro_responsable_id en la fila.
--
-- La lista (vista de la inmobiliaria) muestra en la columna "Responsable" el
-- miembro del equipo asignado al expediente. El front resuelve el nombre desde
-- la lista de miembros (perfil_id → nombre), pero el RPC NO devolvía
-- `miembro_responsable_id`, así que siempre caía a "Sin asignar".
--
-- Agregamos ese campo al json_build_object de cada fila. Recreamos la función
-- completa (idéntica a la versión actual + la línea nueva).
-- ============================================================
